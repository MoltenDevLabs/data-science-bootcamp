...
f = input("Pon una frase: ").lower()                            # El usuario introduce una frase f
l = input("Pon una letra: ").lower()                            # El usuario introduce una letra l

c = 0                                                           # Se inicializa la variable c a 0
for i in f:                                                     # Se recorren las letras de la frase f
  if i == l:                                                    # Se evalua si cada letra convertida a minúscula coincide con la letra l
